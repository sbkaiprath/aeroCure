    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 168.0, middle: 0.4731),
            Pin(size: 27.0, middle: 0.772),
            child: Text(
              'Let\'s get started!',
              style: TextStyle(
                fontFamily: 'Axiforma',
          ...
          Pinned.fromPins(
            Pin(size: 209.0, middle: 0.4749),
            Pin(size: 63.0, middle: 0.4311),
            child: Text(
              'aeroCure',
              style: TextStyle(
                fontFamily: 'Axiforma',
          ...
          Pinned.fromPins(
            Pin(size: 198.0, middle: 0.587),
            Pin(size: 113.0, middle: 0.2817),
            child:
                // Adobe XD layer: 'klipartz.com (4)' (shape)
                Container(
